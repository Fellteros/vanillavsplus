...
public class ModBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup wrapperLookup) {
        ...
        getOrCreateTagBuilder(BlockTags.AXE_MINEABLE)
                ...
                .add(ModBlocks.VERTICAL_STR_PALE_OAK_LOG_SLAB)
                .add(ModBlocks.VERTICAL_STR_PALE_OAK_LOG_STAIRS)

                .add(ModBlocks.VERTICAL_STR_PALE_OAK_WOOD_SLAB)
                .add(ModBlocks.VERTICAL_STR_PALE_OAK_WOOD_STAIRS)
        ...
        Registries.BLOCK.forEach(block -> {
            if (Registries.BLOCK.getId(block).getNamespace().equals(VanillaVSPlus.MOD_ID)) {
                if (block instanceof VerticalSlabBlock) {
                    getOrCreateTagBuilder(ModTags.VERTICAL_SLABS).add(block);
                } else if (block instanceof VerticalStairsBlock) {
                    getOrCreateTagBuilder(ModTags.VERTICAL_STAIRS).add(block);
                }
            }
        });
    }
