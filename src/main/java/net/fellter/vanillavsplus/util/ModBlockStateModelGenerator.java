...
public class ModBlockStateModelGenerator {
	...
	private static BlockStateSupplier createVerticalStairsBlockState(Block vertStairsBlock, Identifier straightLeft, Identifier innerTopLeft, Identifier innerBottomLeft, Identifier outerTopLeft, Identifier outerBottomLeft, Identifier outerTopRight, Identifier outerBottomRight) {
		VariantSetting<Boolean> uvlock = VariantSettings.UVLOCK;
		VariantSetting<VariantSettings.Rotation> y = VariantSettings.Y;
