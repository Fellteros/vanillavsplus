...
public class VVSPStrippableRegistry {
    ...
    public static void registerStrippableBlocks() {
        ...
        register(ModBlocks.VERTICAL_PALE_OAK_LOG_SLAB, ModBlocks.VERTICAL_STR_PALE_OAK_LOG_SLAB);
        register(ModBlocks.VERTICAL_PALE_OAK_LOG_STAIRS, ModBlocks.VERTICAL_STR_PALE_OAK_LOG_STAIRS);
        register(ModBlocks.VERTICAL_PALE_OAK_WOOD_SLAB, ModBlocks.VERTICAL_STR_PALE_OAK_WOOD_SLAB);
        register(ModBlocks.VERTICAL_PALE_OAK_WOOD_STAIRS, ModBlocks.VERTICAL_STR_PALE_OAK_WOOD_STAIRS);
