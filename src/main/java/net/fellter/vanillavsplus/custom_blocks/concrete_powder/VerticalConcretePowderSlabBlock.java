...
public class VerticalConcretePowderSlabBlock extends VerticalFallingSlabBlock {
    private final BlockState hardenedState;

    public VerticalConcretePowderSlabBlock(Settings settings, Block hardened) {
        super(settings);
    ...
    public void onLanding(World world, BlockPos pos, BlockState fallingBlockState, BlockState currentStateInPos, FallingBlockEntity fallingBlockEntity) {
        if (shouldHarden(world, pos, currentStateInPos) && pos != null) {
            world.setBlockState(pos, this.hardenedState
                    ...
                    .with(SINGLE, world.getBlockState(pos).get(SINGLE)), Block.NOTIFY_ALL);
        }
    }
