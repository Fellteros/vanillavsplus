...
public class VerticalRedstoneOreSlabBlock extends VerticalSlabBlock {
    public static final BooleanProperty LIT = RedstoneTorchBlock.LIT;

    public VerticalRedstoneOreSlabBlock(Settings settings) {
        super(settings);
    }
    ...
    protected void appendProperties(StateManager.Builder<Block, BlockState> builder) {
        builder.add(LIT, FACING, WATERLOGGED, SINGLE);
    }
}
